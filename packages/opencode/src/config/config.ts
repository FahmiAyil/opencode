...
export namespace Config {
  ...
  export const Keybinds = z
    .object({
      ...
      mode_list: z.string().optional().default("tab").describe("Show mode selection popup"),
      switch_mode: z.string().optional().default("shift+tab").describe("Next mode"),
      switch_mode_reverse: z.string().optional().default("ctrl+shift+[").describe("Previous Mode"),
